...
basis = find_best_basis_fisher(fisher_tree,N_dec,plot_tree,sim_sig,restric); %fait le calcul additif de la remontée des noeuds pour touver la meilleure base
basis = boolean(basis);
